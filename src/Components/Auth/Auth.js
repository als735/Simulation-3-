...
class Auth extends Component {
    ...
    login = async () => { 
        ...
        // let objData = {data: res.data}
          this.props.dispatch({
          type: FIND_USER,
          payload: res.data 
        })  
        console.log(res.data, 'yep'); 
        this.props.history.push('/dashboard')
      } 
      
        //   const { user_id, username, profile_picture } = res.data[0]
        //   this.props.findThatUser(user_id, username, profile_picture);
    ...
    render(){
        ...
        return(
            <div className='authie'>
              <div className='authieBox'>
                <div>
                  <div>
                  <img className="authieImage" src={authieImage} alt="" />
                  <h1 className="authieTitle">Helo</h1>
                    </div>
                    <div> 
                        <label htmlFor="">
                        Username: 
