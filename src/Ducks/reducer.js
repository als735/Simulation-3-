...
// return an object with all the same props in initialState// The values of the object should be based on the values of the action payload, which is why they are payload.value 
